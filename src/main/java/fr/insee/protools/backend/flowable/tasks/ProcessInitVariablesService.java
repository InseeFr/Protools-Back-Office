   ...
   implements JavaDelegate
 {
   ...
   public void execute(DelegateExecution delegateExecution) {
     this.initVariablesService.initVariables(CommandContextUtil.getProcessEngineConfiguration().getExpressionManager(), (VariableScope)delegateExecution, this.initVariableMap
